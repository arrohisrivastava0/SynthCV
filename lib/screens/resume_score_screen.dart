                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  item['score_impact'] ?? '',
                                  style: GoogleFonts.rubik(
                                    color: (item['score_impact'][0]=='+')?Colors.green:Colors.red,
                                    fontSize: 14,
                                    fontWeight: FontWeight.bold,
                                  ),
                                ),
