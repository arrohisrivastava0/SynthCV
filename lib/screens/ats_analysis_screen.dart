...
class ATSAnalysis extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final parsedSummaries = parseSuggestionSummary(suggestion_summary);
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              HiringProbabilityBar(probabilityLevel: 'Excellent'),
...
// Missing Skills Section
              ...
              const SizedBox(height: 12),
              ...parsedSummaries.map((item) => Container(
              ...
              ...key_suggestions.map((s) => Container(
                    margin: const EdgeInsets.symmetric(vertical: 6),
                    padding: const EdgeInsets.all(12),
                    decoration: BoxDecoration(
